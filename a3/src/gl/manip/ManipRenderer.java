...
public class ManipRenderer implements IDisposable {
	...
	public ManipRenderer() {
		OBJMesh omT = OBJParser.parse("data/meshes/Translate.obj");
		OBJMesh omR = OBJParser.parse("data/meshes/Rotate.obj");
		OBJMesh omS = OBJParser.parse("data/meshes/Scale.obj");
	...
	private int addMesh(OBJMesh om, ByteBuffer vb, ByteBuffer ib, int vi) {
